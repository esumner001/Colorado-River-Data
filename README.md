Model Code by Erin Sumner:
  Assistant Professor of Economics at Regis University
...
With contribution from:
  ...
  James F. Booker - Siena University NY

Base model is calibrated so that observed (endogenous) releases from Lake Mead match total calculated water use for farms and cities added over states, for which marginal benefits of added releases for both ag and urb must be 0 under base conditions
